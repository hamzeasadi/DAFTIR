...
# model template
model_temp = dict(
    blk1=dict(inch=1, outch=32, ks=9, stride=5, pool=False, dropout=False),
    blk2=dict(inch=32, outch=32, ks=4, stride=2, pool=False, dropout=True),
    blk3=dict(inch=32, outch=32, ks=4, stride=2, pool=False, dropout=True),
