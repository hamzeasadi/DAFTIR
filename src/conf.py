...
# model template
model_temp = dict(
    blk1=dict(inch=3, outch=16, ks=9, stride=5, pool=False, dropout=False),
    blk2=dict(inch=16, outch=16, ks=4, stride=2, pool=False, dropout=True),
    blk3=dict(inch=16, outch=8, ks=4, stride=2, pool=False, dropout=True),
