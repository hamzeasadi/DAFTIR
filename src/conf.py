...
model_temp = dict(
    ...
    blk2=dict(inch=8, outch=12, ks=4, stride=2, pool=False, dropout=True),
    blk3=dict(inch=12, outch=16, ks=4, stride=2, pool=False, dropout=True),
    blk4=dict(inch=16, outch=24, ks=3, stride=1, pool=True, dropout=True),
